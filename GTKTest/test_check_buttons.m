...
*/
// $Id: test_check_buttons.m,v 1.2 1998/07/13 12:39:45 helge Exp $
...
id makeCheckButtonWindow(NSString *_title, id _ctrl) {
  ...
  [box addSubWidget:[GTKCheckButton buttonWithTitle:@"button1"]];
  [box addSubWidget:[GTKCheckButton buttonWithTitle:@"button2"]];
  [box addSubWidget:[GTKCheckButton buttonWithTitle:@"button3"]];
